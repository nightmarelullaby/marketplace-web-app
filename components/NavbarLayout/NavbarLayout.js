...
import NavbarResponsive from "../nav/NavbarResponsive"

import {NavbarResponsiveElement} from "../nav/NavbarResponsive"

function NavbarLayout({children}){
  const navStyle = styles.nav
	 console.log(styles.navResponsive)
  
	return(
			<div>
      <div className={styles.navResponsive}>
        <NavbarResponsive >
            <NavbarResponsiveElement style={{marginLeft:"auto"}}>
              <Searchbar 
                searchIcon={[16,16]}
                resetIcon={[26,26]}
          ...
          <NavbarResponsiveElement>
              <PopOver>
                <PopOverTrigger>
                  ...
                  <svg width="24" fill="none" height="24" stroke="var(--light)" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
