...
export default function UserDropdown(){
	...
	return(
		...
		<button onClick={switchState} style={{position:"relative",cursor:"pointer",backgroundColor:"transparent",border:"none",display:"inline-flex",alignItems:"center"}}>
			<svg fill="none" width="18" height="18" stroke="var(--light)" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
		...
		<div style={{display:"flex",flexDirection:"column",gap:4}}>
			<div style={{padding:"12px 16px",display:"flex",gap:8,alignItems:"center"}}>
				<svg fill="black" width="24" height="24"stroke="black" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
		...
		<div style={{padding:"16px 16px",display:"flex",gap:8,alignItems:"center"}}>
				<svg fill="none" width="18" height="18" stroke="red" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  					<path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z"></path>
				</svg>
				<div style={{display:"flex",width:"100%",justifyContent:"space-between"}}>
