        ...
        <PopOver>
            <PopOverTrigger>
                <div style={{position:"relative",display:"flex",alignItems:"center"}}>
                    ...
                    {count.length === 0?null : <div style={{display:"inline-flex",alignItems:"center",position:"absolute",top:-10,left:"100%",backgroundColor:"var(--light)",borderRadius:32,width:18,height:18}}>
                        <small style={{fontSize:11,position:"absolute",top:"%50",left:"50%",translate:"-50% -5%",fontWeight:800,color:"black"}}>{count.length}</small>
                    </div>}
            ...
            <PopOverContent position="bottom">
                ...
                <div style={{borderBottom:"1px solid lightgray",display:"flex",padding:16,justifyContent:"space-between",gap:24,alignItems:"center"}}>
                    <p style={{userSelect:"none",color:"black",fontWeight:400,whiteSpace:"nowrap"}}>Mi carrito ({count.length})</p>
