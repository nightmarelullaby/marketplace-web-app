...
export default function ProductImage(
	...
	return(
		...
		<div className={noHover? {display:"none"}:styles.tag}>
			...
			<img 
				className={noHover ? null : styles.img}
				alt={alt}
				style={style?style:{}}
				src={src}/>
		<div className={noHover ? {display:"none"}:styles.favorite}>
			<svg style={noHover ? {display:"none"}:{}}viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
