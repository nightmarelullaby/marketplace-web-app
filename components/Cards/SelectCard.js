...
export default function SelectCard({title="Default",description="some default text to put under the title. You can change this."}){
	...
	return(
		...
		{/*		<svg style={{marginLeft:"auto",opacity:actualStyle?0:1}}width="24" fill="var(--dominant-blue)" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			...
			{/*<small style={{color:actualStyle?"black":"white",fontWeight:400}}>{description}</small>*/}
		</div>)
}