        ...
        <div className={styles.gameContainer}>
            <section className={styles.container_row}>
                ...
                <div >
                    ...
                    <p className={styles.gameDetails_developer}>{gameData == null ? <small>Cargando...</small>: gameData.developers[0].name}</p>
                    <div className={styles.gameDetails_gridInfo}>
                        ...
                        <div className={styles.grid_column}>
                            ...
                            <p className={styles.grid_column_data} >{gameData.released != null ? gameData.released: "Unknow"}</p>
                        </div>
