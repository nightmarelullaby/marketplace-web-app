...
export default function Id({response}) {
  ...
  return (
    <div style={{padding:"0 32px"}}>
      ...
      <h3>Encuentra los mejores precios</h3>
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <div style={{display:"flex",gap:24}}>
              ...
              <PopOver>
                <PopOverTrigger>
                      <small style={{color:"var(--black)",fontWeight:500}}>Filtros</small>
                      <svg fill="white" width="16"height="16" stroke="var(--black)" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <CategoryList>
            <CategoryListElement active>
              <small style={{color:"var(--black)"}}>Todo</small>
            </CategoryListElement>
            <CategoryListElement>
              <Link href="/resul">
                <small style={{color:"var(--black)"}}>Shirts</small>
              </Link>
            </CategoryListElement>
            <CategoryListElement>
              <small style={{color:"var(--black)"}}>Pants</small>
            </CategoryListElement>
            <CategoryListElement>
              <small style={{color:"var(--black)"}}>Shoes</small>
            </CategoryListElement>
          </CategoryList>
      ...
      <h4 style={{marginBottom:8,color:"var(--black)"}}>Lo mejor en calzado</h4>
      <MoreButton>
      ...
      <div style={{
        ...
        gap:16,
        height:"100vh"}}>{data.products.slice(0,5).map(e=>
      <div key={e.id}>
        <ProductCard 
          customStyles={{
            width:"100%",
            ...
            <NavbarElement>
              <PopOver>
                <PopOverTrigger>
                  ...
                  <svg fill="none" width="16" height="16"stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <PopOverContent position="bottom">
                  <ul style={{padding:24,gap:24,flexDirection:"column",display:"flex"}}>
                    <PopOverLi >
                        <svg  width="32px" height="32px" viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  enable-background="new 0 0 1000 1000" xmlSpace="preserve">
                    ...
                    <PopOverLi >
                        <svg viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  enable-background="new 0 0 1000 1000" xmlSpace="preserve">
